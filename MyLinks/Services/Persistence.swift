...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "MyLinks")
        let sharedStoreURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: Config.groupId)!.appending(path: "MyLinks.sqlite")
        if inMemory {
